...
- P5 (354): MCP registrar (initialize+tools/list→agent surface), prompt renderer, real bin/soxe enable/disable/search/update, config-schema validation enforced at activation with cascade-resolved config.
