...
sox install "$ID_A" --host claude --scope project
...
sox update "$ID_A" --host claude --scope project
...
sox install "$ID_B" --host claude --scope user
...
sox uninstall "$ID_B" --host claude --scope user
...
# =============================================================================
ID_C="di-command"
sox init command "$ID_C"
assert_exit0 "init command $ID_C"
sox install "$ID_C" --host claude --scope local
...
sox install "$ID_D" --host codex --scope project
assert_exit0 "install skill codex project"
assert_dir "$SBX/.codex/skills/${ID_D}"

sox uninstall "$ID_D" --host codex --scope project
