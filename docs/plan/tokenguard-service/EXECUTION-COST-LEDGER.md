...
| 6b | service | tg-service (fix) | sox-active:typescript-pro | _running_ | — | — | _running_ | a34615; focused fix of the ERR_HTTP_HEADERS_SENT response-ordering bug; sonnet (escalate to opus if it can't crack it) |
