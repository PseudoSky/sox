...
Regenerated 2026-08-06: **87 open** (BL-472 resolved 2026-08-06 — shutdown now bounds and drains in-flight Phase-B embeds ahead of `terminateEmbedWorkers()` instead of discarding them, watched red→green across all five acceptance criteria including a genuine end-to-end reproduction; BL-437 resolved 2026-08-06; BL-426 resolved 2026-08-06, see CHANGELOG.md).
