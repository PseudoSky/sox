...
**`vector-store` sites (143, 200, 359) are explicitly untouched** — out of scope per this fix's assignment; the `agent-source` blast radius of converting them is still unmeasured, and BL-380 stays **OPEN** for that remaining half.
