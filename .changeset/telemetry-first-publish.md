...
First npm release of the shared tracing/metrics substrate (BL-351/BL-401), as **0.2.0**.
...
`TelemetrySelfCheck`. That is additive for *callers* — `withSpan`, `otelReady`, `snapshotMetrics`,
