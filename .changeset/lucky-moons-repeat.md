...
'@adhd/sox-extension-memory-usage': patch
'@adhd/sox-extension-sox-memory-bundle': patch
'@adhd/sox-graph-store': patch
'@adhd/sox-hybrid-search': patch
'@adhd/sox-ingest': patch
'@adhd/sox-listen-guard': patch
'@adhd/sox-mcp-runtime': patch
'@adhd/sox-registry': patch
'@adhd/sox-semantic': patch
'@adhd/sox-source-provider': patch
'@adhd/sox-task-queue': patch
'@adhd/sox-tokenguard-core': patch
'@adhd/sox-vector-store': patch
---

Rewrite the package README against real, executed behaviour.
