/**
 * Stats — enrichment coverage and cluster quality statistics.
 *
...
import type { ClusterStats } from '@adhd/sox-memory-core';
...
/**
 * Backing for memory_stats.
 *
 * Aggregates enrichment coverage, cluster quality, and embed health
 * statistics from the database and embed subsystem.
 */
